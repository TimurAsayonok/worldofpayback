...
public enum L10N {
    ...
    public static var noInternetConnectionTitle = localizedString("no_internet_connection_title")
    public static var noInternetConnectionDescription = localizedString("no_internet_connection_description")
}
